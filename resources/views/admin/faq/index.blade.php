...
<div class="content-wrapper">
          ...
          @endif
                  <p class="card-description">
                    <a href="{{ route('admin.create-faq') }}" class="btn btn-primary pull-right" role="button">Add Faq</a>
                  </p>
 ...
 {{$test->status == 1 ? 'Active' : 'In-Active'}}</span> 
                          ...
                          <td>
                            <a href="{{ route('admin.edit-faq',$test->id) }}" class="btn btn-primary">Edit</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="{{ route('admin.delete-faq') }}" method="post">
          @csrf
