...
<div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">All Testimonails</h4>
          ...
          @endif
                  <p class="card-description">
                    <a href="{{ route('admin.create-banner') }}" class="btn btn-primary pull-right" role="button">Add Banner</a>
                  </p>
                    ...
                    <table id="tesTable" class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img src="{{asset('/images/banner/' .$test->bannerimage())}}" alt="">
                          </td>
                          <td>
 ...
 {{$test->status == 1 ? 'Active' : 'In-Active'}}</span> 
                          ...
                          <td>
                            <a href="{{ route('admin.edit-banner',$test->id) }}" class="btn btn-primary">Edit</a>
