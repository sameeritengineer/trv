...
<div class="content-wrapper">
          ...
          @endif
                  <p class="card-description">
                    <a href="{{ route('admin.create-testimonial') }}" class="btn btn-primary pull-right" role="button">Add Testimonial</a>
                  </p>
 ...
 {{$test->status == 1 ? 'Active' : 'In-Active'}}</span> 
                          ...
                          <td>
                            <a href="{{ route('admin.edit-testimonial',$test->id) }}" class="btn btn-primary">Edit</a>
