...
<div class="content-wrapper">
          ...
          @endif
                  <p class="card-description">
                    <a href="{{ route('admin.create-pages') }}" class="btn btn-primary pull-right" role="button">Add Page</a>
                  </p>
 ...
 {{$test->status == 1 ? 'Active' : 'In-Active'}}</span> 
                          ...
                          <td>
                            <a href="{{ route('admin.edit-pages',$test->id) }}" class="btn btn-primary">Edit</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="{{ route('admin.delete-pages') }}" method="post">
          @csrf
          <input type="hidden" name="pagesId" id="pagesId" value="">
