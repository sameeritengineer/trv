...
<div class="content-wrapper">
          ...
          @endif
                  <form class="forms-sample" action="{{ route('admin.update-destination',$destination->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="name" class="form-control" id="exampleInputUsername1" placeholder="Name..." value="{{ old('name',$destination->name) }}">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="number" name="price" class="form-control" id="exampleInputPrice" placeholder="Price($)" value="{{ old('price',$destination->price) }}">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="date" id="destSdaytime" name="destSdaytime" value="{{ old('destSdaytime',$destination->start_date_time) }}">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="date" id="destEdaytime" name="destEdaytime" value="{{ old('destEdaytime',$destination->end_date_time) }}">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="video" name="video" value="{{ old('video',$destination->video) }}">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <option <?php if ($country->id == $destination->countryId){ ?> selected="" <?php } ?> value="{{$country->id}}">{{$country->name}}</option>
                            @endforeach
                            </select>
                            <p class="text-danger">{{ $errors->first('destEdaytime') }}</p>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="hotelname" name="hotelname" value="{{ old('hotelname',$destination->hotelname) }}">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" id="hoteladd" name="hoteladd" value="{{ old('hoteladd',$destination->hoteladd) }}">
                          </div>
                        </div>
                      </div>
                    </div>
                  <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             @php
                              $sql_include = explode(',', $destination->includesId);
                              $sql_exclude = explode(',', $destination->excludesId);
                              $sql_deposite = explode(',', $destination->depositeId);
                              @endphp
                            <select name="includes[]" class="js-example-basic-multiple w-100" multiple="multiple">
                            @foreach($data['includes'] as $include)
                            <option value="{{$include->id}}" <?php if (in_array($include->id, $sql_include)){ ?> selected="" <?php } ?> >{{ $include->name }}</option>
                            @endforeach
                          </select>
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <option value="{{$exclude->id}}" <?php if (in_array($exclude->id, $sql_exclude)){ ?> selected="" <?php } ?>>{{$exclude->name}}</option>
                            @endforeach
                            </select>
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <option value="{{$deposite->id}}" <?php if (in_array($deposite->id, $sql_deposite)){ ?> selected="" <?php } ?>>{{$deposite->name}}</option>
                            @endforeach
                            </select>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                          <textarea id="addinfo"  name="addinfo" class="form-control">{{ old('addinfo',$destination->addinfo) }}</textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-12">
                          <textarea id="summernote"  name="description" class="form-control content"> {{ old('description',$destination->description) }}</textarea>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                           <div class="field_wrapper">
                            ...
                            <div>
                              <h5>Day {{$i+1}}</h5>
                                <input class="form-control" type="text" name="activities[]" value="{{$activities[$i]}}"/>
                                @if($i == 0)
                                <a href="javascript:void(0);" class="add_button btn btn-primary mr-2" title="Add field">Add</a>
                                @else
                                <a href="javascript:void(0);" class="remove_button btn btn-primary mr-2">Remove</a>
                                @endif
                            </div>
                            @endfor
                           </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                              <label>Destination Gallery Images</label>
                                ...
                                <span class="">
                                    <input type="file" name="dest_gallery[]" id="files_before_images" accept="image/*" capture="camera" id="files_before_images" multiple>
                                </span>
                                </div>
                            </div>
                            <br>
                          <output>
                              <ul id="Filelist_Before">
                                @php
                                $gallery = explode(',',$destination->dest_gallery);
                                $count_gallery = count($gallery);
                                @endphp
                                @for ($i = 0; $i < $count_gallery; $i++)
                                @if(!empty($destination->dest_gallery))
                                <li>
                                  <div class="img-wrap">
                                    <a href="{{ route('admin.gallery-image',[$destination->id,$gallery[$i]]) }}"><span data-param="batch" class="close">×</span></a>
                                    <img onclick="currentSlideBatch(1)" data-toggle="modal" data-target="#exampleModalBatch" class="thumb" src="{{ asset('/images/destination/gallery/'.$gallery[$i]) }}" title="{{$gallery[$i]}}" data-id="{{$gallery[$i]}}">
                                  </div>
              ...
              <div class="form-group">
                ...
                <div id="image_preview">
                  <br>
                 <img class="thumb" src="{{ asset('/images/destination/'.$destination->image) }}" title="{{$destination->image}}">
                </div>
              ...
              <hr>
                    <div class="form-check form-check-flat form-check-primary">
                      <label class="form-check-label">
                        <input type="checkbox" name="status" value="1" @if(old('status' , $destination->status)=="1") checked @endif > Status
                      </label>
                    </div>
...
@for ($i = 0; $i < $count_gallery; $i++)
<div class="mySlidesbefore"><img src="{{ asset('/images/destination/gallery/'.$gallery[$i]) }}" style="width:100%"></div>
@endfor
</div>
