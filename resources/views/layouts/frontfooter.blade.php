                              ...
                              <ul>
                                 <li>
                                    <figure class="post-thumb">
                                       <a href="blog-archive.html"><img src="{{asset('frontend-asset/images/img21.jpg')}}" alt=""></a>
                                    </figure>
                                 ...
                                 <li>
                                    <figure class="post-thumb">
                                       <a href="blog-archive.html"><img src="{{asset('frontend-asset/images/img22.jpg')}}" alt=""></a>
                                    </figure>
                                    <div class="post-content">
                                       <h6>
                              ...
                              <div class="gallery gallery-colum-3">
                                 <figure class="gallery-item">
                                    <a href="assets/images/img10.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img21.jpg')}}" alt="">
                                    </a>
                                 </figure>
                                 <figure class="gallery-item">
                                    <a href="assets/images/img28.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img22.jpg')}}" alt="">
                                    </a>
                                 </figure>
                                 <figure class="gallery-item">
                                    <a href="assets/images/img14.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img23.jpg')}}" alt="">
                                    </a>
                                 </figure>
                                 <figure class="gallery-item">
                                    <a href="assets/images/img15.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img24.jpg')}}" alt="">
                                    </a>
                                 </figure>
                                 <figure class="gallery-item">
                                    <a href="assets/images/img12.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img25.jpg')}}" alt="">
                                    </a>
                                 </figure>
                                 <figure class="gallery-item">
                                    <a href="assets/images/img13.jpg" data-fancybox="gallery-1">
                                       <img src="{{asset('frontend-asset/images/img26.jpg')}}" alt="">
                                    </a>
                                 </figure>
                              </div>
                           </aside>
